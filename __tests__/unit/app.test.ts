...
describe('handlePostConditionEntity', () => {
  const sampleCondition: EntityCondition = {
    ...
    prsptv: 'both',
    incptnDtTm: '2024-08-07T21:00:00.999Z',
    xprtnDtTm: '2024-08-08T21:00:00.999Z',
    condRsn: 'R001',
    ntty: {
      id: '+27733161225',
      schmeNm: {
    ...
    conditions: [
      {
        condId: '13480',
        condTp: 'overridable-block',
        incptnDtTm: '2024-08-16T21:00:00.999Z',
        xprtnDtTm: '2024-08-17T21:00:00.999Z',
        condRsn: 'R001',
        usr: 'bob',
...
describe('handlePostConditionAccount', () => {
  const sampleCondition: AccountCondition = {
    ...
    prsptv: 'both',
    incptnDtTm: '2024-09-01T21:00:00.999Z',
    xprtnDtTm: '2024-09-03T21:00:00.999Z',
    condRsn: 'R001',
    acct: {
      id: '1010101012',
      schmeNm: {
