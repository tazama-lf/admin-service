...
const routePrivilege = {
  ...
  postTcsConfig: 'view-profile',
  getTcsConfig: 'view-profile',
  getTcsConfigs: 'view-profile',
  getTcsConfigRelatedTransactions: 'view-profile',
  putTcsConfig: 'view-profile',
  patchTcsConfigPublishingStatus: 'view-profile',
  deleteTcsConfig: 'view-profile',
  getTcsConfigByTransaction: 'view-profile',
  getTcsConfigByEndpoint: 'view-profile',
  postTcsConfigWrite: 'view-profile',
  putTcsConfigWrite: 'view-profile',
  deleteTcsConfigWrite: 'view-profile',
  postTcsRawQuery: 'view-profile',
  postTcsConfigMapping: 'view-profile',
  putTcsConfigMapping: 'view-profile',
  deleteTcsConfigMapping: 'view-profile',
  postTcsConfigFunction: 'view-profile',
  putTcsConfigFunction: 'view-profile',
  deleteTcsConfigFunction: 'view-profile',
  postTcsWorkflowSubmit: 'view-profile',
  postTcsWorkflowApprove: 'view-profile',
  postTcsWorkflowReject: 'view-profile',
  postTcsWorkflowRequestChanges: 'view-profile',
  postTcsWorkflowDeploy: 'view-profile',
  postTcsWorkflowExport: 'view-profile',
  postTcsWorkflowReturnToProgress: 'view-profile',
  ...
  postTcsDataModelDestinationType: 'view-profile',
  getTcsDataModelDestinationTypeExists: 'view-profile',
  postTcsDataModelDestinationTypeField: 'view-profile',
  postTcsDataModelTransactionTypeTable: 'view-profile',
  postTcsDataModelTable: 'view-profile',
